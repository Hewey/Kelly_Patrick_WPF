...
var froggyIntro = prompt("Hey kids welcome to the Bob the Froggy Simulator! \nHere we can simulate the amount of distance Bob travels depending on the number you enter! Bob travels 5 ft per jump. Enter the number jumps you want Bob to make!");
